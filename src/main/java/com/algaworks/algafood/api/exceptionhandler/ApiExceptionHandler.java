...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public static final String MSG_ERRO_GENERICA_USUARIO_FINAL = "Ocorreu um erro interno ineesperado no sistema. "
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        if (rootCause instanceof InvalidMediaTypeException) {
            return hadleInvalidFormat((InvalidFormatException) rootCause, headers, status, request);
    ...
    private ResponseEntity<Object> hadleInvalidFormat(
    ...
    private ResponseEntity<Object> handleMethodArgumentTypeMismatch(
        ...
        String detail = String.format("O parâmetro de URL '%s' recebeu o valor '%s', "
                        + "que é de um tipo inválido. Corrijqaa e informe um valor compatível com o tipo %s.",
    ...
    private ResponseEntity<Object> handleValidationInternal(Exception ex, HttpHeaders headers, HttpStatus status, WebRequest request, BindingResult bindingResult) {
        ...
        Problem problem = createProblemBuilder(status, problemType, detail)
                ...
                .objects(problemObjects)
                .build();
        return super.handleMethodArgumentNotValid((MethodArgumentNotValidException) ex, headers, status, request);
    }
